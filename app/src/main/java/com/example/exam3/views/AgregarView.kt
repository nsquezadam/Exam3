...
@Composable
fun AgregarView(navController:NavController, viewModel: ReservaViewModel){
    Scaffold(
        topBar = {
...
@Composable
fun ContentAgregarView(it:PaddingValues, navController: NavController, viewModel: ReservaViewModel){
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                viewModel.agregarReserva(reser)
